  ...
  return (
    <div>
      ...
      <div className="w-full px-4 sm:w-[400px] md:w-[480px] lg:w-[512px] m-auto">
        ...
        <button className="mb-[30px] font-bold w-full bg-[transparent] border border-[#0071bc] hover:text-white text-[#0071bc] py-4 px-4 rounded mt-2 hover:bg-[#0071bc] transition duration-300">
         Register
        </button>
